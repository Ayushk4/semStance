...
parser.add_argument("--num_heads", type=int, default=3, help="Number of parallel attention heads in each transformer encoder layer.")
parser.add_argument("--num_layers", type=int, default=3, help="Number of layers stacks of transformer encoder.")
...
parser.add_argument("--trans_ip_dims", type=int, default=102, help="Input_dimensions for transformer.")
